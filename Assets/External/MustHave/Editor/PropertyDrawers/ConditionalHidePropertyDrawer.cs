...
namespace MustHave.UI
{
    ...
    public class ConditionalHidePropertyDrawer : PropertyDrawer
    {
        ...
        private bool GetConditionalHideAttributeResult(ConditionalHideAttribute condHAtt, SerializedProperty property)
        {
            ...
            //Debug.LogWarning(GetType().Name + ".GetConditionalHideAttributeResult: " + property.displayName + " / " + property.name);
            //Debug.LogWarning(GetType().Name + ".GetConditionalHideAttributeResult: " + sourcePropertyValue.displayName + " / " + sourcePropertyValue.name);
            //Debug.LogWarning(GetType().Name + ".GetConditionalHideAttributeResult: " + enabled);
